...
describe('i18n messages', () => {
  ...
  it('every en key has a zh counterpart', () => {
    ...
    const enKeys = [
      ...
      'app.tips.click', 'app.tips.filter', 'app.tips.persist',
      'header.aiProvider', 'header.aiMock', 'header.lang',
      'input.title', 'input.hintRemote',
      ...
      'input.focuses', 'input.run', 'input.submitting',
      'input.noFiles',
      ...
      'tree.title', 'tree.empty',
      'tree.expand', 'tree.collapse',
      'tree.expandAria', 'tree.collapseAria',
      'tree.openDrawer', 'tree.closeDrawer',
      'viewer.title', 'viewer.chooseFile', 'viewer.noDiff',
      'viewer.added', 'viewer.removed',
      'drawer.closeAria', 'drawer.historyAria', 'drawer.tipsAria',
      'header.historyButton', 'header.tipsButton',
