...
const messages = {
  en: {
    ...
    // I7: review-result layout redesign (tree + single-file viewer)
    'tree.title': 'Files',
    'tree.empty': 'No files changed',
    'tree.expand': 'Expand folder',
    'tree.collapse': 'Collapse folder',
    'tree.expandAria': 'Expand {folder}',
    'tree.collapseAria': 'Collapse {folder}',
    'tree.openDrawer': 'Show file tree',
    'tree.closeDrawer': 'Hide file tree',
    'viewer.title': 'Review',
    'viewer.chooseFile': 'Pick a file from the tree to view its diff and findings.',
    'viewer.noDiff': 'No diff for this file',
    'viewer.added': '+{n}',
    'viewer.removed': '-{n}',
    'drawer.closeAria': 'Close drawer',
    'drawer.historyAria': 'History drawer',
    'drawer.tipsAria': 'Tips drawer',
    'header.historyButton': 'History',
    'header.tipsButton': 'Tips',
  ...
  zh: {
    ...
    'tree.expand': '展开文件夹',
    'tree.collapse': '收起文件夹',
    'tree.expandAria': '展开 {folder}',
    'tree.collapseAria': '收起 {folder}',
    'tree.openDrawer': '显示文件树',
    'tree.closeDrawer': '隐藏文件树',
    'viewer.title': '评审',
    'viewer.chooseFile': '从文件树中选择一个文件以查看其 diff 与评审。',
    'viewer.noDiff': '本文件无 diff',
    'viewer.added': '+{n}',
    'viewer.removed': '-{n}',
    'drawer.closeAria': '关闭抽屉',
    'drawer.historyAria': '历史抽屉',
    'drawer.tipsAria': '小贴士抽屉',
    'header.historyButton': '历史',
    'header.tipsButton': '小贴士',
